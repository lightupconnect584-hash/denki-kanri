          ...
          content: [
            docBlock,
            {
              ...
              text:
                ...
                "【最重要】写真が不鮮明な場合、確実に判読できる文字だけを採用してください。かすれ・ぼやけ・手書きなどで文字が確信を持って読めない項目は、似た文字で推測して埋めず、必ず空文字にしてください。特に氏名（カナ）・建物名・住所などの固有名詞は、一文字でも不確かなら空文字にしてください。間違った内容を入れるより、空欄にして手入力してもらう方が安全です。" +
