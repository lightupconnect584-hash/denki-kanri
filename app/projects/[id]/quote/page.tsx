    ...
    <div className="min-h-full flex flex-col bg-gray-900 [color-scheme:dark]">
      ...
      <main className="flex-1 max-w-lg lg:max-w-2xl mx-auto w-full px-4 py-4 sm:py-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-lg font-bold text-gray-100">見積もりを提出</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4" onKeyDown={(e) => { if (e.key === "Enter" && e.nativeEvent.isComposing) e.preventDefault(); }}>
          <div className="bg-gray-800 rounded-xl border border-gray-700 p-5 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-600 rounded-lg px-3 py-2 text-sm text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full border border-gray-600 rounded-lg px-3 py-2 text-sm text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
            ...
            <div>
              ...
              <label className="flex items-center justify-center gap-2 w-full border-2 border-dashed border-gray-600 rounded-xl py-4 cursor-pointer hover:border-blue-400 hover:bg-blue-900/40 transition">
              ...
              {file && (
                <p className="text-xs text-green-400 mt-1">✓ {file.originalName} をアップロードしました</p>
              )}
            </div>
          </div>
          ...
          <button
            ...
            className="w-full bg-orange-900/300 text-white rounded-xl py-3 text-sm font-medium hover:bg-orange-600 disabled:opacity-50 transition"
          >
